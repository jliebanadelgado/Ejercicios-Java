package Ejercicios_Iniciales;/*2. A la botiga The bike house es fa un descompte del 20% als clients que son VIP i també
        als clients que facin una compra de més de 200 €. Pensa un algoritme que implementi
        aquesta lògica.*/


import java.util.Scanner;
public class ExercicisInicials2_DescuentoTrueFalseYColores {
