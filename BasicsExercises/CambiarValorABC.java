...
public class CambiarValorABC {
	...
	intercanviï el valor de les variables.*/
        ...
        /*El contenido del vaso "b" lo meto en el vaso "c" (entonces me queda el baso "c" lleno del
         * contenido del "b" y el vaso "b" me queda vacio).
         */
        c = b;

        /*El contenido del vaso "a" lo meto en el vaso "b" que esta vacio ya que el contenido
         * del "b" lo he metido en el vaso "c".
         */
        b = a;

        /*Y el contenido del vaso "c" que tenia dentro el contenido del vaso "b" lo meto en el vaso
